...
resp_table = {
    ...
    "303": "See Other",
    # 400 - END
    "400": "Server ran into problem." # WebTV Cretes alert based on awk: 400 {alert_text}
}
...
class SendFile:
    def __init__(self, file: str=None, headers: dict=default_headers):
        self.file = file
        self.headers = headers
